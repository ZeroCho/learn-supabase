...
> **Tip**: Supabase는 관계형 데이터베이스(PostgreSQL)이므로, 테이블 간의 관계(Foreign Key)를 잘 설정하는 것이 핵심입니다.

### 2. Row Level Security (RLS) 개념
